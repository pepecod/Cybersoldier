...
# NUEVO: multiplicador de área desde el arma
...
func _ajustar_tamaño() -> void:
	# Calcula el radio base + nivel + multiplicador de área
	...
	print("🔍 SniperBullet nivel %d → radio %.2f, scale %.2f, área mult: %.2f" 
		% [level, radio, escala, area_multiplicador])
